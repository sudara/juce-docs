\hypertarget{_a_u_dispatch_8h_source}{}\doxysection{AUDispatch.\+h}
\label{_a_u_dispatch_8h_source}\index{build/juce\_audio\_plugin\_client/AU/CoreAudioUtilityClasses/AUDispatch.h@{build/juce\_audio\_plugin\_client/AU/CoreAudioUtilityClasses/AUDispatch.h}}
\mbox{\hyperlink{_a_u_dispatch_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{1 \textcolor{comment}{/*}}
\DoxyCodeLine{2 \textcolor{comment}{     File: AUDispatch.h}}
...
\DoxyCodeLine{47 \textcolor{preprocessor}{\#ifndef \_\_AUDispatch\_h\_\_}}
\DoxyCodeLine{48 \textcolor{preprocessor}{\#define \_\_AUDispatch\_h\_\_}}
\DoxyCodeLine{49 }
\DoxyCodeLine{50 }
...
\DoxyCodeLine{56 }
\DoxyCodeLine{57 \textcolor{preprocessor}{\#if !CA\_USE\_AUDIO\_PLUGIN\_ONLY}}
\DoxyCodeLine{59 OSStatus \mbox{\hyperlink{_a_u_dispatch_8h_a06ef38903ad0b231deb8484ed37412d1}{CMgr\_AudioUnitBaseGetParameter}}(  \mbox{\hyperlink{class_a_u_base}{AUBase}} *              This,}
\DoxyCodeLine{60                                             AudioUnitParameterID    inID,}
\DoxyCodeLine{61                                             AudioUnitScope          inScope,}
\DoxyCodeLine{62                                             AudioUnitElement        inElement,}
\DoxyCodeLine{63                                             \textcolor{keywordtype}{float} *                 outValue);}
\DoxyCodeLine{64 }
\DoxyCodeLine{66 OSStatus \mbox{\hyperlink{_a_u_dispatch_8h_aeac9a18200ff5e11fc7ff8688709c0a1}{CMgr\_AudioUnitBaseSetParameter}}(  \mbox{\hyperlink{class_a_u_base}{AUBase}} *              This,}
\DoxyCodeLine{67                                             AudioUnitParameterID    inID,}
\DoxyCodeLine{68                                             AudioUnitScope          inScope,}
\DoxyCodeLine{69                                             AudioUnitElement        inElement,}
\DoxyCodeLine{70                                             \textcolor{keywordtype}{float}                   inValue,}
\DoxyCodeLine{71                                             UInt32                  inBufferOffset);}
\DoxyCodeLine{72 }
\DoxyCodeLine{74 OSStatus \mbox{\hyperlink{_a_u_dispatch_8h_a95b530c7802b52559619bb81bc77382c}{CMgr\_AudioUnitBaseRender}}(          \mbox{\hyperlink{class_a_u_base}{AUBase}} *              This,}
\DoxyCodeLine{75                                             AudioUnitRenderActionFlags *ioActionFlags,}
\DoxyCodeLine{76                                             \textcolor{keyword}{const} AudioTimeStamp *  inTimeStamp,}
\DoxyCodeLine{77                                             UInt32                  inBusNumber,}
\DoxyCodeLine{78                                             UInt32                  inNumberFrames,}
\DoxyCodeLine{79                                             AudioBufferList *       ioData);}
\DoxyCodeLine{80 \textcolor{preprocessor}{\#endif}}
\DoxyCodeLine{81 }
\DoxyCodeLine{82 \textcolor{preprocessor}{\#endif }\textcolor{comment}{// \_\_AUDispatch\_h\_\_}}
