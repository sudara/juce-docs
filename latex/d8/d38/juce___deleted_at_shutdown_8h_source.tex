\hypertarget{juce___deleted_at_shutdown_8h_source}{}\doxysection{juce\+\_\+\+Deleted\+At\+Shutdown.\+h}
\label{juce___deleted_at_shutdown_8h_source}\index{build/juce\_events/messages/juce\_DeletedAtShutdown.h@{build/juce\_events/messages/juce\_DeletedAtShutdown.h}}
\mbox{\hyperlink{juce___deleted_at_shutdown_8h}{Go to the documentation of this file.}}
\begin{DoxyCode}{0}
\DoxyCodeLine{1 }
...
\DoxyCodeLine{40 \textcolor{comment}{}\textcolor{keyword}{class }\mbox{\hyperlink{group__juce__core-system_ga65961b3bfbda0ffb83750d914cee38fb}{JUCE\_API}}  \mbox{\hyperlink{class_deleted_at_shutdown}{DeletedAtShutdown}}}
\DoxyCodeLine{41 \{}
\DoxyCodeLine{42 \textcolor{keyword}{protected}:}
\DoxyCodeLine{44     \mbox{\hyperlink{class_deleted_at_shutdown}{DeletedAtShutdown}}();}
\DoxyCodeLine{45 }
\DoxyCodeLine{51     \textcolor{keyword}{virtual} \mbox{\hyperlink{class_deleted_at_shutdown}{\string~DeletedAtShutdown}}();}
\DoxyCodeLine{52 }
\DoxyCodeLine{53 }
\DoxyCodeLine{54 \textcolor{keyword}{public}:}
\DoxyCodeLine{60     \textcolor{keyword}{static} \textcolor{keywordtype}{void} deleteAll();}
\DoxyCodeLine{61 }
\DoxyCodeLine{62 \textcolor{keyword}{private}:}
\DoxyCodeLine{63     \mbox{\hyperlink{group__juce__core-system_ga6ab7a603bf4435c7cb286b1744366eb2}{JUCE\_DECLARE\_NON\_COPYABLE}} (\mbox{\hyperlink{class_deleted_at_shutdown}{DeletedAtShutdown}})}
\DoxyCodeLine{64 \};}
\DoxyCodeLine{65 }
